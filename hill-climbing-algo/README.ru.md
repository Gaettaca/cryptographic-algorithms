...
1. "ATTACK  AT  DOWN" - осмысленный текст; зашифруем его использую шифр простой замены.
2. "EXXEGO EX HSAR" - в осмысленности этого текста можно усомниться, бессмысленный набор букв.
...
Для шифр-текста в файле _src/encrypted/ct1.txt_ правильный ключ - _UESLPACMBNVIHKYJTFGDXWZOQR_ был получен меньше, чем за 1000 итераций, а осмысленность расшифрованного текста составила -2394, при начальной -11549. Код, а также расшифрованные и зашифрованные тексты можно посмотреть в ./src
